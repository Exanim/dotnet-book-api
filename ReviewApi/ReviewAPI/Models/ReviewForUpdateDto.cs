...
{ 
    /// <summary>
    /// Represents a review object without the primary key, used to update an existing entry in the database
    /// </summary>
    [DataContract]
    public partial class ReviewForUpdateDto : IEquatable<ReviewForUpdateDto>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewForUpdateDto {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ReviewForUpdateDto)obj);
        }

        /// <summary>
        /// Returns true if ReviewForUpdateDto instances are equal
        /// </summary>
        /// <param name="other">Instance of ReviewForUpdateDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewForUpdateDto other)
        {
        ...
        public static bool operator ==(ReviewForUpdateDto left, ReviewForUpdateDto right)
        {
