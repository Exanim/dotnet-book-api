            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("0.0.1", new OpenApiInfo
                    {
                        ...
                        Description = "Books Microservice (ASP.NET Core 3.1)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/0.0.1/openapi.json", "Books Microservice");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Books Microservice Original");
                });
            app.UseRouting();
